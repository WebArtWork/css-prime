 ...
 *
 */
import type { StyleOptions, ThemeOptions } from '@wawjs/css-prime-styled';
...
// @todo: Remove this when the types are fixed in the styled package. Use `ColorScale` from `@wawjs/css-prime-styled` instead.
