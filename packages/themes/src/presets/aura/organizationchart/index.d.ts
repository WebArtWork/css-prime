import type { OrganizationChartTokenSections } from '@wawjs/css-prime-themes/types/organizationchart';

export * from '@wawjs/css-prime-themes/types/organizationchart';
